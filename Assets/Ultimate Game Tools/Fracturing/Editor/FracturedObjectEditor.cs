...
public class FracturedObjectEditor : Editor
{
    ...
    SerializedProperty logicCollision;
    ...
    void OnEnable()
    {
        ...
        logicCollision         = serializedObject.FindProperty("logicCollision");
    ...
    public override void OnInspectorGUI()
    {
        ...
        if(fracturedComponent.GUIExpandEvents)
        {
            ...
            EditorGUILayout.PropertyField(logicCollision,           new GUIContent("Call GameObject",        "The GameObject whose method will be called."));
            EditorGUI.indentLevel -= nIndentationJump;
        }
